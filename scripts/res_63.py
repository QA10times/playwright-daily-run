...
def run(playwright: Playwright) -> None:
    ...
    page.get_by_role("button", name="Event Ranking").first.click()
    page.get_by_role("button", name="Estimated Exhibitors Show").first.click()
    page.get_by_role("checkbox", name="0-100", exact=True).click()
    page.get_by_role("checkbox", name="-1000").click()
    page.get_by_role("button", name="Apply Filters").click()
    page.get_by_role("tab", name="Table").click()
    check_element(page, "Est. Exhibitors")
