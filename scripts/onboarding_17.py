...
def get_temp_email_and_otp():
    with sync_playwright() as p:
        ...
        page2.goto("https://geo.whr.ai/signup")  # Replace with your signup page URL
        ...
        try:
            ...
            page.wait_for_selector("text=no-reply@geo.whr.ai", timeout=30000)
            # Open the first email in the inbox
            page.locator("text=no-reply@geo.whr.ai").click()
        ...
        try:
            ...
            page2.get_by_text("Skip for now").click()
