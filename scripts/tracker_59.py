...
def run(playwright: Playwright) -> None:
    ...
    page.get_by_role("button", name="Skip").click()
    time.sleep(3)
    page.locator("#peopleTracker").get_by_role("link", name="New tracker").nth(1).click()
    page.get_by_role("button", name="Skip").click()
    page.get_by_role("textbox", name="Speaker's Name").click()
    page.get_by_role("textbox", name="Speaker's Name").fill("Sal Khan")
